"""
Unified message code definitions for backend; frontend localizes by code.
Usage: get_message_code("SESSION_FEEDBACK_SUBMITTED")
"""
...
# Legacy key to constant mapping
LEGACY_KEY_MAPPING = {
...
def get_message_code(key: str) -> str:
    """Get message code; supports constant name, legacy key (case-insensitive)."""
